                ...
                <div class="mx-auto" style="width: 700px;">
                    ...
                    <!-- Input of content goes here.  -->
                        ...
                        <?php
                            ...
                            echo "<h3 class='text-center fa-bold'><strong>Product Price Setting</strong></h3>";   
                            echo "<hr>";
                            ...
                            if($result = mysqli_query($dbs, $sql)){
                                if(mysqli_num_rows($result) > 0){
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        echo "<tr>";
                                            echo "<td><h6><a style='text-decoration: none;' href='AlterItem.php?id=" .$row['Item_Id'] . "'>" . $row['Item_Id'] . "</a></h6><td>";
                                            echo "<td><a style='text-decoration: none;' href='AlterItem.php?id=" .$row['Item_Id'] . "'>" . $row['Item_Name'] . "</a></td>";
                                            echo "<td><a style='text-decoration: none;' href='AlterItem.php?id=" .$row['Item_Id'] . "'>$". $row['Item_Price'] . "</a></td>";
                                        echo "</tr>";
                                    }
                                    echo "</table>";
                                    // Free result set
