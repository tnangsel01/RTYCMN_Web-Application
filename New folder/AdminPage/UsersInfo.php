                    ...
                    <!-- input of content goes here.  -->
                        ...
                        <?php
                            include("connection.php");
                                ...
                                echo "<h3 class='text-center fa-bold'><strong>Users LogIn Credentials</strong></h3>";
                                echo "<hr>";
                                $sql = "SELECT * FROM Users";
                                if($result = mysqli_query($dbs, $sql)){
                                    if(mysqli_num_rows($result) > 0){
                                        echo "<div class='table-reponsive'>";
                                            echo "<table class='table table-sm table-hover table-bordered text-center'>";
                                                ...
                                                echo "<tr>";
                                                   ...
                                                   ?>
                                                    ...
                                                    //  <?php 
                                                    //     echo "<td><input type='number' min=0 max=1 name='change_admin'></td>";
                                                    //     echo "<td><button type='submit' name='AdminChange' class='btn btn-success btn-block'>Change UserType</button></td>";
                                                    //     ?>
                                                    // </form>
                                                     -->
                                                     <?php
...
<?php
    ...
    //     $value = htmlspecialchars($_POST['change_admin']);
    //     $query = "UPDATE Users SET Admin = '$value' WHERE User_Id = $row['User_Id']";
    //     $update = mysqli_query($dbs, $query);
    //     if($update){
    //         echo"<script>
    //         alert('Changed UserType successfullly!');
